...
export function DockerfileMonaco({ value, onChange }: Props) {
    ...
    return <div ref={containerRef} className="h-[60vh] min-h-[420px] w-full overflow-hidden rounded-xl border border-border" />;
}
